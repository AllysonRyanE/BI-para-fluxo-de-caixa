...
# Projeto: BI com Power Bi sobre Movimentação de Caixa de uma agência de publicidade.

## 📕 Resumo

Este projeto tem como propósito analisar uma série de dados referente a um biênio de movimentações de caixa numa agência de publicidade a fim de avaliar as motivações que tem reverberado em prejuizo e após trata-los minuciosamente, seleciona-los de maneira que proporcione visualizações e consultas em diferentes niveis que possam auxiliar na tomada de decisões.
